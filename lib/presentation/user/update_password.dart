                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                       ...
                       state is! LoadingUpdatePasswordState? defaultButton(context, label: "Confirm", fontSize: 20,
                            function: () {
                              if (formKey.currentState!.validate()) {
                                if (passwordController.text ==
                                    confPasswordController.text) {
                                  UserDataCubit.get(context).updatePassword(password: passwordController.text);
                                }else{
                                  toastMSG(text: "Passwords are't match", color: Colors.red);
                                }
                              }
